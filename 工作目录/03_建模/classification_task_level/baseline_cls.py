...
def write_report(all_results, X_shape, y, groups):
    lines = []
    lines.append("# P0 任务级 3 分类 Baseline 报告\n\n")
    ...
    lines.append("- 类别分布：低 31 / 中 24 / 高 29\n\n")
    lines.append("**基线参考**：\n")
    lines.append("- Dummy_stratified（按类别比例随机猜）：期望 acc ≈ 0.348\n")
    lines.append("- Dummy_most_frequent（永远猜'低'）：期望 acc = 31/84 = 0.369\n")
